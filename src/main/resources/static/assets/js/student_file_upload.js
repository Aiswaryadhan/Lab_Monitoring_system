...
//             stud_id/sub_id/date/file.extention
    ...
    $("#studentLogout").click(function(){
                ...
                $.ajax({
                                         type: "POST",
                                         url: 'http://192.168.42.202:8080/loggedStudent/delete/'+studId,
    ...
    function uploadFile() {
        ...
        if(filename!=''){
            $.ajax({
                url: "http://192.168.42.202:8080/uploadFile/"+studId+'/'+teacherSub,
                type: "POST",
...
//                alert("success");
                $.ajax({
                                url: "http://192.168.42.202:8080/student/upload/"+studId+'/'+teacherSub+'/'+filename,
                                type: "POST",
                                success: function () {
//                                            alert("success");
                                            $.ajax({
                                                url: "http://192.168.42.202:8080/student/getUploadDetails/"+studId+'/'+teacherSub,
                                                type: "POST",
                                                success: function (data) {
                                                     len = data.length;
                                                     var txt = "";
