...
//             stud_id/sub_id/date/file.extention
    ...
    $("#studentLogout").click(function(){
                ...
                $.ajax({
                                         type: "POST",
                                         url: 'http://d76524e0.ngrok.io/loggedStudent/delete/'+studId,
    ...
    function uploadFile() {
        ...
        if(filename!=''){
            $.ajax({
                url: "http://d76524e0.ngrok.io/uploadFile/"+studId+'/'+teacherSub,
                type: "POST",
...
//                alert("success");
                $.ajax({
                                url: "http://d76524e0.ngrok.io/student/upload/"+studId+'/'+teacherSub+'/'+filename,
                                type: "POST",
                                success: function () {
//                                            alert("success");
                                            $.ajax({
                                                url: "http://d76524e0.ngrok.io/student/getUploadDetails/"+studId+'/'+teacherSub,
                                                type: "POST",
                                                success: function (data) {
                                                     len = data.length;
                                                     var txt = "";
