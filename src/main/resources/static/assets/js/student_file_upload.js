...
//             stud_id/sub_id/date/file.extention
    ...
    function uploadFile() {
        ...
        if(filename!=''){
            $.ajax({
                url: "http://1fb077bb.ngrok.io/uploadFile/"+studId+'/'+teacherSub,
                type: "POST",
...
//                alert("success");
                $.ajax({
                                url: "http://1fb077bb.ngrok.io/student/upload/"+studId+'/'+teacherSub+'/'+filename,
                                type: "POST",
                                success: function () {
//                                            alert("success");
                                            $.ajax({
                                                url: "http://1fb077bb.ngrok.io/student/getUploadDetails/"+studId+'/'+teacherSub,
                                                type: "POST",
                                                success: function (data) {
                                                     len = data.length;
                                                     var txt = "";
