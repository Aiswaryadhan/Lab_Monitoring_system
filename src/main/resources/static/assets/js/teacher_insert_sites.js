                                                                          ...
                                                                          success:function(data){
                                                                                  ...
                                                                                  if(len > 0){
                                                                                                  for(i=0;i<len;i++){
                                                                                                      ...
                                                                                                      t1=arr[1];
                                                                                                      txt += "<li name=\""+req1+"\"><a href=\"#\" class=\"notification-item\"><span class=\"dot bg-warning\"></span>"+requester+" has asked for screen sharing </a><p class=\"timestamp\">Date & Time @ " +t1+"</p></li>";
                                                                                                  }
                                                                                                  if(txt!=''){
